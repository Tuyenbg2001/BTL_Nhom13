...
<div class="row">
    ...
    <a href="{{route('order.waiting')}}" class="card-link">
    ...
    <!-- <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-success shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Đơn hàng mỗi tháng</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">'none' 100</div>
                    </div>
                    <div class="col-auto">
    ...
    <!-- <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-success shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Đơn hàng mỗi năm</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">'none' 2000</div>
                    </div>
                    <div class="col-auto">
                        <i class="fas fa-calendar fa-2x text-gray-300"></i>
                    </div>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">'none' 5</div>
                    </div>
                    <div class="col-auto">
                        <i class="fas fa-comments fa-2x text-gray-300"></i>
                    </div>
    ...
    <!-- <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-warning shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Báo cáo sự cố</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">'none' 5</div>
                    </div>
                    <div class="col-auto">
                        <i class="fas fa-comments fa-2x text-gray-300"></i>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mt-4 text-center small">
                    ...
                    <span class="mr-2">
                        <i class="fas fa-circle text-success"></i> Mọi người
                    </span>
                    <span class="mr-2">
                        <i class="fas fa-circle text-info"></i> Giói thiệu
                    </span>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-6 mb-4">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <h4 class="small font-weight-bold">Thiết lập tài khoản<span class="float-right">Đã hoàn thành!</span></h4>
                <div class="progress">
