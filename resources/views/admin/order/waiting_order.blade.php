...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Danh sách đơn hàng chờ</h6>
    </div>
    <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center">
                            ...
                            <?php } else { ?>
                                <a href="{{URL('/order-unhandle/'.$order->id)}}"><i class="fa-2x fas fa-archive text-success"></i></a>
                            <?php } ?>
                        </td>
                        <td>{{ $order->id}}</td>
                        ...
                        <!-- <td class="text-center">
                            ...
                            <a href="{{URL('/delete-order/'.$order->id)}}" onclick="return confirm('Bạn có chắn chắn xóa đơn hàng này không?')"><button class="btn btn-danger mb-1"><i class="fas fa-trash-alt"></i></button></a>
                        </td> -->
                    </tr>
                    @endforeach
                </tbody>
